...
#ifndef LIFECOUNTER_SWIFT_H
#define LIFECOUNTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="lifecounter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11lifecounter11AppDelegate")
...
SWIFT_CLASS("_TtC11lifecounter13SceneDelegate")
...
- (void)viewDidLoad;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerOneInfo;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerTwoInfo;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified playerInfo;
- (IBAction)pressButton:(UIButton * _Nonnull)sender;
